...
<div class="card-content">
  ...
  <h3>${product.price}$</h3>
  <div class="buts">
  <button id="but1" class="btn btn-sm btn-outline-dark" onclick="addToCart(${product.id})">Add to cart</button>
  <button id="but1"><a class="catego-a" href="./cart.html">CART</a></button>
  </div>
</div>
`;
